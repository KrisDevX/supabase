...
- **Write timeless documentation, cut redundancy, and prefer a paragraph to a single-item list.** See [timeless documentation](../../../apps/docs/style-guide/02-page-structure.md#write-timeless-documentation), [brevity](../../../apps/docs/style-guide/01-voice-and-tone.md#brevity), and [lists](../../../apps/docs/style-guide/03-elements.md#lists).
...
- [ ] Document type, section grouping, and chunking follow [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md)
- [ ] Admonitions, headings, links, and other components follow [`03-elements.md`](../../../apps/docs/style-guide/03-elements.md)
