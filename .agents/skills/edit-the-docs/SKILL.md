...
1. Identify the document type per [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md#document-types). The types are explainer, tutorial, guide, reference, and troubleshooting.
...
- Put procedures in procedure format. Per-step formatting is in [`03-elements.md`](../../../apps/docs/style-guide/03-elements.md#procedures); how many steps to present at once and when to split into phases is in [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md#chunking).
- Apply [`03-elements.md`](../../../apps/docs/style-guide/03-elements.md) for admonitions, emphasis, links, and lists, and [`01-voice-and-tone.md`](../../../apps/docs/style-guide/01-voice-and-tone.md) for person, tense, and sentence-level grammar.
...
- Time-anchored language and unshipped features: [timeless documentation](../../../apps/docs/style-guide/02-page-structure.md#write-timeless-documentation). Internal planning context in shipped MDX: [keep internal context out](../../../apps/docs/style-guide/02-page-structure.md#keep-internal-context-out). Repeated points: [brevity](../../../apps/docs/style-guide/01-voice-and-tone.md#brevity). Single-item lists and restated admonitions: [`03-elements.md`](../../../apps/docs/style-guide/03-elements.md).
...
Apply [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md) — section grouping, navigation, and glue. This section is the procedure for doing that on an existing page; the rules live in the guide.
...
Classify each one against the information types in [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md#information-types), then collapse them into the three buckets you'll group by: **procedural** (Procedure), **contextual** (Concept and Process), and **reference** (Structure and Fact).
...
Order the groups per [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md#grouping-sections), which has the order that works and a worked outline. The action path runs uninterrupted and the background sits after it.
...
- Section grouping, navigation, glue, and chunking: [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md)
- Procedure format and other components: [`03-elements.md`](../../../apps/docs/style-guide/03-elements.md)
