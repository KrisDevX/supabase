...
How a Supabase docs sentence reads: who it addresses, what tense it takes, how long
it runs, and how much of it you can cut. This document applies to every sentence you
write, whether you're drafting a page or changing one line on an existing one.

It covers the sentence. For how a page divides into sections, see
...
| Where to look something up               | [Resources](#resources)                         |
...
Supabase docs use American English. Where this guide doesn't cover a case, these do:

- [`WORD_LIST.md`](./WORD_LIST.md) — Supabase terminology, spelling, and
  capitalization. Check it before you draft and again before you open a pull request.
- [Google developer documentation style guide](https://developers.google.com/style) —
  general technical writing. Punctuation, capitalization beyond headings, inclusive
  language, and code samples, all in more depth than this guide goes.
- [Chicago Manual of Style](https://www.chicagomanualofstyle.org/home.html) — general
  English, for points Google doesn't reach.
- [Merriam-Webster](https://www.merriam-webster.com/) — American English spelling.
