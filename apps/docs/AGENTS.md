...
- `style-guide/README.md` — the procedure, and what to follow if a rule isn't there
...
- `style-guide/02-page-structure.md` — document type, section grouping, chunking
- `style-guide/03-elements.md` — admonitions, code blocks, procedures, tabs, images
